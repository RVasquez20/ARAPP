...
import com.example.location.activities.user.ImagenActivity;
...
public class ItemListDialogFragment extends BottomSheetDialogFragment implements OnItemClickListener, OnItemLongClick {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            context = getContext();
            imageActivity = (ImagenActivity) getActivity();
            imagens = imageActivity.getImagens();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        imageAdapter = new ImageAdapter(imagens, this, this, 2, 1);
